...
if (useCookieSessionStore === 'true') {
  console.log('Running with Cookies Session On')
  ...
  console.log('Running with Express Session On')
...
// SSO 
const { getConfiguredPassport } = require('./app/auth');
(async () => {
  // Get all OIDC config with Discovery link - add try block here
  console.log('retriving discovery values');
  ...
  app.get('/auth/login', (req, res, next) => {
    passport.authenticate('oidc', { scope: 'openid email phone', nonce: uuid(), state: uuid(),}) (req, res, next);
  })
  ...
  */
  ...
  app.get('/auth/callback', (req, res, next) => {
    ...
    passport.authenticate('oidc', (err, user, info) => {
      if (err) { 
        console.log('ERROR DG', err);
        return res.redirect('/protected'); 
      }
      /*
      if (!user) { 
        console.log('ERROR NOT USER DG');
        return res.redirect('/protected'); 
      }*/ 
      console.log('worked !! dg', user, info);
